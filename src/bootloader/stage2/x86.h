...
void _cdecl x86_Disk_Read(uint8_t drive, uint16_t cylinder, uint16_t head, uint16_t sector, uint16_t count, uint8_t far* dataOut);
void _cdecl x86_Disk_GetDriveParams(uint8_t drive, uint16_t* driveTypeOut, uint16_t* sectorsOut, uint16_t* headsOut);
